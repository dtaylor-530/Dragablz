...
namespace Dragablz
{
    ...
    public interface IInterTabClient
    {
        ...
        /// <returns></returns>
        INewTabHost<Window> GetNewHost(IInterTabClient interTabClient, object partition, DragablzItem source);
        ...
        /// <returns></returns>
        TabEmptiedResponse TabEmptiedHandler(DragablzItem tabControl, Window window);
    }
}