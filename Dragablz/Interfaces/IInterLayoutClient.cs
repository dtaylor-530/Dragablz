...
{
    /// <summary>
    /// Implementors should provide a mechanism to provide a new host control which contains a new <see cref="DragablzItem"/>.
    /// </summary>
    public interface IInterLayoutClient
    {
        ...
        /// <returns></returns>
        INewTabHost<UIElement> GetNewHost(object partition, DragablzItem source);
    }
}